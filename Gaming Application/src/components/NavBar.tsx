        ...
        <nav className="flex justify-between px-8 py-4 bg-gray-900 text-white">
            ...
            <ul className="flex gap-6 items-center">
                {['Home', 'Contact', 'About', 'Logout'].map((item) => (
                    <li key={item}>
                        <a className="hover:text-red-400 transition-all duration-200 cursor-pointer">{item}</a>
                    </li>
                ))}
                <li>
                    <a className="bg-purple-500 hover:bg-blue-700 px-4 py-1 rounded-lg transition-all duration-200 cursor-pointer">Login</a>
                </li>
                <li>
